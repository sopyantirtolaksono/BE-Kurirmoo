...
import (
	...
	"kurirmoo/pkg/client/update_city"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Kurirmoo {
	...
	cli.UpdateCity = update_city.New(transport, formats)
	return cli
}
...
type Kurirmoo struct {
	...
	UpdateCity update_city.ClientService
...
func (c *Kurirmoo) SetTransport(transport runtime.ClientTransport) {
	...
	c.UpdateCity.SetTransport(transport)
}
