...
import (
	...
	"kurirmoo/pkg/client/update_trip_status"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Kurirmoo {
	...
	cli.UpdateTripStatus = update_trip_status.New(transport, formats)
	return cli
}
...
type Kurirmoo struct {
	...
	UpdateTripStatus update_trip_status.ClientService
...
func (c *Kurirmoo) SetTransport(transport runtime.ClientTransport) {
	...
	c.UpdateTripStatus.SetTransport(transport)
}
