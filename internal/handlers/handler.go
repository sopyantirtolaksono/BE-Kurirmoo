...
type (
	...
	UpdateDriverHandler interface {
		UpdateDriver(ctx context.Context, rt *kurirmoo.Runtime, ID int64, PhoneNumber string, PhoneNumber2 string) (message string, err error)
	}
)
